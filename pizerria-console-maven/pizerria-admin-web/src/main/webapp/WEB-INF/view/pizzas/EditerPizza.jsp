			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="textinput1" name="code" type="text"
						placeholder="${pizzAModif.code}" value="${pizzAModif.code}" class="form-control input-md" required="">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="textinput2" name="nom" type="text"
						placeholder="${pizzAModif.nom}" value="${pizzAModif.nom}"  class="form-control input-md" required="">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<input id="textinput" name="prix" type="text"
						placeholder="${pizzAModif.prix}" value="${pizzAModif.prix}"  class="form-control input-md" required="">
				...
				<div class="col-md-4">
					<div class="input-group">
						<input id="buttondropdown" name="categorie"
							class="form-control" placeholder="${pizzAModif.categorie}" value="${pizzAModif.categorie}"  type="text" required="">
